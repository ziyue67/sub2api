...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	billingRiskStore := repository.NewBillingRiskStore(redisClient)
	billingCacheService := service.ProvideBillingCacheService(billingCache, userRepository, userSubscriptionRepository, apiKeyRepository, userRPMCache, userGroupRateRepository, configConfig, serviceUserPlatformQuotaRepository, billingRiskStore)
	...
	billingRiskGuard := service.NewBillingRiskGuard(billingRiskStore, settingService)
	billingRiskEstimator := service.NewBillingRiskEstimator(billingService, modelPricingResolver)
	billingRiskAdmissionService := service.NewBillingRiskAdmissionService(billingRiskGuard, billingRiskEstimator, userGroupRateRepository, configConfig)
	...
	gatewayHandler := handler.ProvideGatewayHandler(gatewayService, openAIGatewayService, geminiMessagesCompatService, antigravityGatewayService, userService, concurrencyService, billingCacheService, usageService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, userMessageQueueService, configConfig, settingService, billingRiskAdmissionService, coordinator)
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, opsService, grokQuotaService, billingRiskAdmissionService, configConfig, coordinator)
