...
const (
	...
	TransportPlugin_NominateAccount_FullMethodName  = "/sub2api.plugin.v1.TransportPlugin/NominateAccount"
)
...
type TransportPluginClient interface {
	...
	NominateAccount(ctx context.Context, in *NominateAccountRequest, opts ...grpc.CallOption) (*NominateAccountResponse, error)
}
...
func (c *transportPluginClient) NominateAccount(ctx context.Context, in *NominateAccountRequest, opts ...grpc.CallOption) (*NominateAccountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NominateAccountResponse)
	err := c.cc.Invoke(ctx, TransportPlugin_NominateAccount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TransportPluginServer interface {
	...
	NominateAccount(context.Context, *NominateAccountRequest) (*NominateAccountResponse, error)
...
func (UnimplementedTransportPluginServer) InitHostServices(context.Context, *InitHostServicesRequest) (*InitHostServicesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InitHostServices not implemented")
}
func (UnimplementedTransportPluginServer) NominateAccount(context.Context, *NominateAccountRequest) (*NominateAccountResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NominateAccount not implemented")
}
...
func RegisterTransportPluginServer(s grpc.ServiceRegistrar, srv TransportPluginServer) {
	// If the following call pancis, it indicates UnimplementedTransportPluginServer was
...
func _TransportPlugin_NominateAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NominateAccountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransportPluginServer).NominateAccount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransportPlugin_NominateAccount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransportPluginServer).NominateAccount(ctx, req.(*NominateAccountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TransportPlugin_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "NominateAccount",
			Handler:    _TransportPlugin_NominateAccount_Handler,
		},
	},
...
func (UnimplementedHostServiceServer) ResolveOutboundIdentity(context.Context, *ResolveOutboundIdentityRequest) (*ResolveOutboundIdentityResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ResolveOutboundIdentity not implemented")
}
