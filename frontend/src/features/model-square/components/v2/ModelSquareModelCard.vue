<template>
  <article
    ...
    class='scroll-mt-6 bg-white dark:bg-dark-900 border border-gray-200 dark:border-dark-800 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden'
  >
    <header class='px-6 py-4 flex items-start justify-between border-b border-gray-100 dark:border-dark-800 bg-gray-50/30 dark:bg-dark-950/20'>
      <div class='min-w-0'>
