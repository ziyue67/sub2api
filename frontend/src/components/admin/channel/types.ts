...
export function getPlatformTagClass(platform: string): string {
  switch (platform) {
    ...
    case 'deepseek': return 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300'
...
export function getPlatformTextClass(platform: string): string {
  switch (platform) {
    ...
    case 'deepseek': return 'text-indigo-700 dark:text-indigo-300'
    default: return ''
  }
}
