<template>
  ...
  <svg v-else-if="normalizedPlatform === 'kimi'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M4 3h4v7l6-7h5l-7.2 8.1L20 21h-5.1L8 12.9V21H4V3z" />
  </svg>
  <!-- Zhipu AI logo mark -->
  <svg v-else-if="normalizedPlatform === 'zhipu'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
  ...
  <!-- DeepSeek logo -->
  <ModelIcon v-else-if="normalizedPlatform === 'deepseek'" model="deepseek" :size="modelIconSize" />
