export default {
    accounts: {
      ...
      upstreamUsage: {
        ...
        unsupported: '不支持',
        failed: '查询失败',
        updatedAt: '查询时间：{value}',
        probeFailed: '查询上游剩余失败',
        noEligibleAccounts: '请选择 API Key 账号',
        batchLimit: '每次最多查询 20 个账号',
        batchCompleted: '已完成 {count} 个账号的上游剩余查询',
        batchPartial: '上游剩余查询部分完成：成功 {success} 个，失败 {failed} 个'
      },
