export default {
    accounts: {
      ...
      columns: {
        ...
        upstreamUsage: 'Upstream Remaining',
        weight: 'Weight',
      ...
      opencodeGo: {
        ...
        // 上游 v0.2.5 新增的账号模式与协议分流文案，并入本块以避免重复键
        accountMode: {
          zen: 'Zen',
      ...
      upstreamUsage: {
        refresh: 'Query upstream remaining',
        notQueried: 'Upstream remaining not queried',
        unavailable: 'Unavailable',
        stale: 'Stale',
        unsupported: 'Unsupported',
        failed: 'Query failed',
        updatedAt: 'Queried: {value}',
        probeFailed: 'Failed to query upstream remaining',
        noEligibleAccounts: 'Select API key accounts',
        batchLimit: 'A batch can query at most 20 accounts',
        batchCompleted: 'Queried upstream remaining for {count} account(s)',
        batchPartial: 'Query partially completed: {success} succeeded, {failed} failed'
      },
      ...
      bulkActions: {
        ...
        probeUpstreamUsage: 'Query Upstream Remaining',
